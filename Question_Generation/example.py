...
# Now, you can pass 'text_from_pdf' to the question generation functions and inspect the generated questions.
# Call the appropriate question generation function here and inspect the output.
# For example:
generated_questions = generate_questions_mcq(text_from_pdf, Sense2Vec)
# or
# generated_questions = generate_normal_questions(text_from_pdf, ...)
